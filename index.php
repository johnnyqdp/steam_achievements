...
<body>     
    <div class="content" id="content">
        ...
        <h3 style="margin-bottom:20px; text-align:center" class="texto">Estatísticas de <span title="Inserir outro usuário" style="border-bottom:dotted" id="nomeUsuario" class="nomeUsuario"><i class="fa fa-spin fa-spinner texto"></i></span></h2>
